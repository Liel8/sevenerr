...
//           <img className="home-icon" src="/assets/home-c41832c6.svg" alt="Home" title="Go to homepage"/>
//         </a>
//         <span className="divider">/</span>
...
//         <section className="package-heading">
//           <h2 className="price">
//             <span className="price-font">$ 15</span>
//           </h2>
//         </section>
//         <h3 className="package-desc">
//           <span className="package">Bronze </span>
...
//         </h3>
//         <span className="days-container">
//           <img className="icon clock" src="/assets/time-dc3d893c.svg" alt="clock-icon"/>
//           <h3>4 Days Delivery</h3>
//         </span>
//         <ul className="feature-list">
//           <span className="feature-container">
//             <img className="icon check" src="/assets/check-9e9ebecb.svg" alt="check-icon"/>
//             1 concept included
//           </span>
//           <span className="feature-container">
//             <img className="icon check" src="/assets/check-9e9ebecb.svg" alt="check-icon"/>
...
//     <section className="top-details container full main-layout">
//       <div className="owner-details-container">
//         <h1 className="gig-title">I will create custom company logo design for your business</h1>
//         <div className="profile-container">
//           <img src="https://res.cloudinary.com/de2rdmsca/image/upload/w_1000,c_fill,ar_1:1,g_auto,r_max,bo_5px_solid_red,b_rgb:262c35/v1696177526/cld-sample.jpg" alt="owner-img" className="owner-profile-img-meduim"/>
//           <div className="owner-details">
//             <div className="user-container">
//               <h3 className="user-title">Taylor P</h3>
//               <span className="username">@taylor_paul10</span>
...
//             <div className="star-wrapper">
//               <span className="star-svg">
//                 <img src="/assets/star-grey-4c21a46d.svg" alt="star-svg" className="star"/>
//               </span>
//               <span className="owner-rate">5</span>
//               <span className="owner-number-rates">(224)</span>
//               <span className="divider">|</span>
...
//                   <li className="slide">
//                     <img src="https://res.cloudinary.com/dgsfbxsed/image/upload/v1698674928/taylor-2_uqjv74.webp"/>
//                   </li>
//                   <li className="slide selected previous">
//                     <img src="https://res.cloudinary.com/dgsfbxsed/image/upload/v1698674928/taylor-1_nmgnmv.webp"/>
//                   </li>
//                   <li className="slide">
//                     <img src="https://res.cloudinary.com/dgsfbxsed/image/upload/v1698674928/taylor-2_uqjv74.webp"/>
//                   </li>
...
//             <div className="carousel">
//               <div className="thumbs-wrapper axis-vertical">
//                 <button type="button" className="control-arrow control-prev control-disabled" aria-label="previous slide / item"></button>
//                 <ul className="thumbs animated" style="transform: translate3d(0px, 0px, 0px); transition-duration: 350ms;">
//                   <li className="thumb selected" aria-label="slide item 1" role="button" tabindex="0" style="width: 100px;">
//                     <img src="https://res.cloudinary.com/dgsfbxsed/image/upload/v1698674928/taylor-1_nmgnmv.webp"/>
//                   </li>
//                   <li className="thumb" aria-label="slide item 2" role="button" tabindex="0" style="width: 100px;">
//                     <img src="https://res.cloudinary.com/dgsfbxsed/image/upload/v1698674928/taylor-2_uqjv74.webp"/>
//                   </li>
//                 </ul>
//                 <button type="button" className="control-arrow control-next control-disabled" aria-label="next slide / item"></button>
//               </div>
//             </div>
//           </div>
//         </div>
...
//     <div className="about-gig">
//       <h1 className="gig-about-title">About this gig</h1>
//       <p className="gig-description">Captivating, enriched, elaborate and original is what I believe you're looking for. Your business logo deserves to be created by somebody who gets your business. I am professional designer offering high-quality business Logo design services since 2013 and branding solutions to all kind of businesses</p>
//     </div>
//     <div className="user-info">
//       <h1 className="about-seller">About the seller</h1>
//       <section className="user-mini-detail">
//         <div className="owner-img-wrapper flex">
//           <img src="https://res.cloudinary.com/de2rdmsca/image/upload/w_1000,c_fill,ar_1:1,g_auto,r_max,bo_5px_solid_red,b_rgb:262c35/v1696177526/cld-sample.jpg" alt="owner-img" className="owner-profile-img-large"/>
//           <div className="owner-details mini">
//             <div className="user-info">
//               <h3 className="gig-title">Taylor P</h3>
//               <span className="username">@taylor_paul10</span>
...
//             </li>
//           </ul>
//           <article>Are you looking for an expert logo designer to design your logo? If your answer is yes, then I welcome you and you are at the right place.</article>
//         </div>
//       </section>
//     </div>
//     <div className="user-reviews ">
...
//               <h4>11 reviews for this seller</h4>
//               <div className="stars">
//                 <img src="/assets/star-grey-4c21a46d.svg" alt="star" className="star"/>
//                 <img src="/assets/star-grey-4c21a46d.svg" alt="star" className="star"/>
//                 <img src="/assets/star-grey-4c21a46d.svg" alt="star" className="star"/>
//                 <img src="/assets/star-grey-4c21a46d.svg" alt="star" className="star"/>
//                 <img src="/assets/star-grey-4c21a46d.svg" alt="star" className="star"/>
...
//             <li className="review-preview">
//               <img src="https://res.cloudinary.com/dgsfbxsed/image/upload/v1699297771/wwalxfxyg1msfp25zack.jpg" className="seller-img"/>
//               <div className="review-detail">
//                 <div className="seller-info">
//                   <h4 className="seller-name">Raz Amsalem</h4>
//                   <div className="country">
//                     <img className="flag" alt="flag" src="https://res.cloudinary.com/dgsfbxsed/image/upload/v1698928453/israel_rtvzid.png"/>
//                     <span>Israel</span>
//                   </div>
//                 </div>
//                 <div className="rate-info">
...
//                   <span>Helpful?</span>
//                   <div className="thums" style="color: rgb(34, 35, 37);">
//                     <img src="/assets/thums-up-07d2fc96.svg" alt="thumsUpGreen" id="yes"/>
//                     <span id="yes">Yes</span>
//                   </div>
//                   <div className="thums" style="color: rgb(34, 35, 37);">
//                     <img src="/assets/thums-down-004a2262.svg" alt="thumsDown" id="no"/>
//                     <span id="no">No</span>
//                   </div>
//                 </div>
//               </div>
