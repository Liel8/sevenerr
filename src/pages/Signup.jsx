...
export function Signup() {
  ...
  // credentials מכיל: fullname, username, password, imgUrl
  ...
  async function onSignup(ev) {
    ...
    // בדיקה תקינות סיסמה (אורך + אותיות + מספר)
    if (!isValidPassword) {
      setError(
      ...
      <form className="signup-form" onSubmit={onSignup}>
        ...
        <label>
          ...
          <div className="criteria-list">
            <div className={credentials.password.length >= 8 ? 'valid' : ''}>
            ...
            <div className={/[A-Z]/.test(credentials.password) ? 'valid' : ''}>
              <span className="check-icon">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
            ...
            <div className={/\d/.test(credentials.password) ? 'valid' : ''}>
              <span className="check-icon">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
