    ...
    <section className="details-container">
          ...
          <div className="user-profile-desc">
            <div className="user-stats">
              ...
              <div className="user-lang with-border-top">
                ...
                <ul>
                  <li><span className="title">English</span> - <span className="sub-title">Fluent</span></li>
                  <li><span className="title">Hebrew</span> - <span className="sub-title">Fluent</span></li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <section className="orders-column">
        ...
        <section className="my-gigs">
          <h2>My Gigs</h2>
          <div className="gigs-list flex wrap gap-4">
            {userGigs.map(gig => (
              <button
                key={gig._id}
                className="gig-preview-btn flex column align-center"
                ...
                />
                <h4 className="mt-2 text-sm text-center">{gig.title}</h4>
              </button>
            ))}
          </div>
        </section>
...
//         {/* Add Gig button below the table */}
//         <button
//           onClick={() => navigate('/gig/add')}
//           className="btn add-gig-btn"
//         >
