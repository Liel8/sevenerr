...
import { CtaPayment } from './CtaPayment'
...
//     }
    ...
    return (
        <section className="cta-container">
            <CtaPayment/>
            {/* <CtaPayment isOpen={isModalOpen} onClose={closeModal} >
            ...
            <article className={`call-to-action ${isPurchase ? 'buyer' : ''}`}>
                <figure className='preview-container'>
                    {/* {isPurchase &&  */}
                    <img src={imgUrls[0] || imgNotFound} alt="Selected gig image preview" onError={e => e.currentTarget.src = imgNotFound} />
                    {/* } */}
                    {/* {isPurchase &&  */}
                    <span className='package-desc'>{title}</span>
                    {/* } */}
                </figure>
                ...
                {/* {isPurchase &&  */}
                <section className="package-heading flex">
                ...
                <div className="summary">
                    <div className="summary-table">
                        ...
                        <div className="tax-fee flex">
                            <span className='vat'>VAT <span className="fa-solid fa-circle-question icon" title='A 17% Value Added Tax (VAT) applies to the purchase of goods and services in your region.'></span></span><span>$98</span>
                        </div>
                    </div>
                    <div className="summary-footer">
                        <div className="user-price flex">
                            <span className='price'>You’ll pay</span><span>$98</span>
                        </div>
